...
<div class="portas">
  <a class="porta" href="livro.html">
    ...
    <p>O livro. Vinte e um capítulos organizados por velocidade de envelhecimento, cada
    seção com meia-vida, estado e data de revisão declarados.</p>
    <span class="st">Camadas 0 e 1 escritas · 4 de 21 capítulos</span>
  </a>
  ...
  <div class="mast-in">
    <div>
      ...
      <div class="status">
        ...
        <span class="chip">21 capítulos</span>
    ...
    <div class="strata">
      ...
      <div class="band"><div class="lab">Escrito<em>capítulos</em></div>
        <div class="bar" style="background:var(--s1);height:1.9rem"></div><div class="hv">4 de 21</div></div>
      <div class="band"><div class="lab">Com ficha<em>capítulos</em></div>
        <div class="bar" style="background:var(--s2);height:1.6rem"></div><div class="hv">21 de 21</div></div>
      ...
      duas semanas e as fichas dos 21 capítulos.</p>
    </div>
  </div>
</header>
